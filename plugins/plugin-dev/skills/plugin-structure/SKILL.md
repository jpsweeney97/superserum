...
description: Use for "plugin structure", "plugin.json manifest", "auto-discovery", or "component organization". Also for directory layout, file naming, or ${CLAUDE_PLUGIN_ROOT} usage.
version: 0.1.0
---
